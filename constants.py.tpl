...
MESSAGES = ['Auth OK', 'Subscription ended', 'Unknown user', 'Wrong auth type', 'Unregistered device', 'Inconsistent MAC', 'Wrong machine owner', 'LDAP error']
WIFI_VLAN = 1451
SUBSCRIPTION_VLAN = 1311
LOG_LINE = '{}// radius.authentication{{ip={},port={},mac={},uid={},real_uid={},status={},auth={}}} 1\n'
